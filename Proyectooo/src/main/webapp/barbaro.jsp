...
<h1 class="encabezado" style="color: azure" >Registro de Bárbaro</h1>

<div class="centrado">
    <form action="barbaro" method="post">
    ...
    <font color="yellow" >
    <p>Para mas informacion puede guiarse por el siguiente link, pagina 32</p></font>
    <a href="http://huertadesolymar.uy/D&D5Manual.pdf" style="color: yellow">Manual de Jugador D&D 5ta edicion</a>
    <br>
    <br>
    <br>
