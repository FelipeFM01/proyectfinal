...
<h1 class="encabezado">Registro de Hechicero</h1>

<div class="centrado">
    <form action="hechicero" method="post">
    ...
    <p>Para mas informacion puede guiarse por el siguiente link, pagina 70 </p>
    <a href="http://huertadesolymar.uy/D&D5Manual.pdf">Manual de Jugador D&D 5ta edicion</a>
    <br>
    <br>
    <br>
